...
const router = useRouter(); const sessions = useGameSessions(); const identity = useIdentity();
...
.together-card__reviews{ display:flex; flex-direction:column; gap:4px; color:var(--text-dim); font-size:var(--fs-sm); line-height:1.45; }.together-card__reviews strong{ color:var(--game-accent); }
</style>
